...
echo "3️⃣  Base ctrl";            pytest -q tests/test_base_controller.py
echo "4️⃣  Controllers";          pytest -q tests/test_linear_controller.py
echo "4️⃣  Controllers";          pytest -q tests/test_lqr_controller.py
#echo "4️⃣  Controllers";          pytest -q tests/test_nn_controller.py
#echo "5️⃣  Closed-loop";          pytest -q tests/test_closedloop.py
