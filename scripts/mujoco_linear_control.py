...
from lib.linear_gr import train_linear_controller
...
def main():
    ...
    from lib.linear_gr import TrainingConfig, create_cost_matrices
    ...
    if ctrl is None:
        ...
        initial_K = jnp.array(lin_cfg.get('w_init', [1.0, 10.0, 1.0, 1.0]))
